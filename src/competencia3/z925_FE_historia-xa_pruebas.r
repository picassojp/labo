...
PARAM  <- list()
PARAM$experimento <- "FE9250-xa_pruebas"

#las pruebas se hacen con el dataset de la 3ra competencia
...
dataset_input  <- paste0( "./", PARAM$exp_input, "/competencia3_2022.csv.gz" )
dataset1  <- fread( dataset_input )
dataset <- dataset1[sample(nrow(dataset1), size = 50000),]
...
if( PARAM$Tendencias )
{
  TendenciaYmuchomas( dataset, 
                      ...
                      ventana=  6,      # 6 meses de historia Cambio: agrego 12 meses
                      tendencia= TRUE,
                      minimo=    FALSE,
                      maximo=    FALSE,
                      promedio=  TRUE,
...
if( PARAM$Tendencias )
{
  TendenciaYmuchomas( dataset, 
                      cols= cols_lagueables,
                      ventana=  12,      # 6 meses de historia Cambio: agrego 12 meses
                      tendencia= TRUE,
                      minimo=    FALSE,
                      maximo=    FALSE,
                      promedio=  TRUE,

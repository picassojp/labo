...
PARAM  <- list()
PARAM$experimento <- "TS9320KF5"

PARAM$exp_input  <- "FE9250KF0"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201901, 201902, 201903, 201904, 201905,201906,201907,201908,201909, 202001, 202002, 202003, 202004, 202005, 202007, 202008, 202009, 202101, 202102, 202103, 202104, 202105)

PARAM$train$training     <- c( 201901, 201902, 201903, 201904, 201905,201906,201907,201908,201909, 202001, 202002, 202003, 202004, 202005, 202007, 202008, 202009, 202101, 202102, 202103, 202104, 202105)
...
PARAM$train$semilla_sampling  <- semillas[1]
PARAM$train$semilla_under     <- semillas[2]

#Script original: z1291_SM_semillero_lgbm_under.R commit 39a07dd de @tomasdelvechio
...
PARAM <- list()
PARAM$experimento <- "ZZ9420KF1_semillerio"
PARAM$exp_input <- "HT9420KF1"

# PARAM$modelos  <- 2
PARAM$modelo <- 1 # se usa el mejor de la OB, pero a futuro podria variar esto
PARAM$semilla_primos <- 668111

...
PARAM  <- list()
PARAM$experimento <- "TS9320KF6"

PARAM$exp_input  <- "FE9250KF0"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201907,201908,201909, 202007, 202008, 202009, 202101, 202102, 202103, 202104, 202105)

PARAM$train$training     <- c( 201907, 201908, 201909, 202007, 202008, 202009, 202101, 202102, 202103, 202104, 202105)
